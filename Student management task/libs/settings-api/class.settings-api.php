...
class WeDevs_Settings_API {
     ...
     * @param array   $args settings field args
     */
    function callback_h2( $args ) {

        $value = esc_html( $args['desc'] );

        $html  = sprintf( '<h2 id="%1$s[%2$s]">%3$s</h2>', $args['section'], $args['id'], $value );
    ...
    function show_forms() {
        ...
        <div class="metabox-holder">
            <?php do_action('easy_student_results_settings_error'); ?>
            <?php do_action('easy_student_results_settings_success'); ?>
